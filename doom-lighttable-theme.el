...
;;;; Base theme face overrides
  (((line-number &override) :foreground base4)
   ...
   (magit-section-heading :foreground fg)
   ...
   (magit-header-line :background fg :foreground bg :box `(:line-width 3 :color ,bg))
   ...
   (swiper-match-face-4 :background "#295E5F" :foreground "#6DFBFD")
        ...
        ;; all-the-icons
   (all-the-icons-blue       :foreground bg)
   (all-the-icons-blue-alt   :foreground bg)
   (all-the-icons-cyan       :foreground bg)
   (all-the-icons-cyan-alt   :foreground bg)
   (all-the-icons-dblue      :foreground bg)
   (all-the-icons-dcyan      :foreground bg)
   (all-the-icons-dgreen     :foreground bg)
   (all-the-icons-dmaroon    :foreground bg)
   (all-the-icons-dorange    :foreground bg)
   (all-the-icons-dpink      :foreground bg)
   (all-the-icons-dpurple    :foreground bg)
   (all-the-icons-dred       :foreground bg)
   (all-the-icons-dsilver    :foreground bg)
   (all-the-icons-dyellow    :foreground bg)
   (all-the-icons-green      :foreground bg)
   (all-the-icons-lblue      :foreground bg)
   (all-the-icons-lcyan      :foreground bg)
   (all-the-icons-lgreen     :foreground bg)
   (all-the-icons-lmaroon    :foreground bg)
   (all-the-icons-lorange    :foreground bg)
   (all-the-icons-lpink      :foreground bg)
   (all-the-icons-lpurple    :foreground bg)
   (all-the-icons-lred       :foreground bg)
   (all-the-icons-lsilver    :foreground bg)
   (all-the-icons-lyellow    :foreground bg)
   (all-the-icons-maroon     :foreground bg)
   (all-the-icons-orange     :foreground bg)
   (all-the-icons-pink       :foreground bg)
   (all-the-icons-purple     :foreground bg)
   (all-the-icons-purple-alt :foreground bg)
   (all-the-icons-red        :foreground bg)
   ...
   (font-latex-warning-face     :foreground warning)
   (TeX-error-description-warning  :foreground warning)
   (alert-high-face       :foreground warning)
   ...
   (erm-syn-warnline :foreground warning)
   ...
   (objed-mode-line :foreground warning)
   (org-warning :foreground warning)
   (org-pomodoro-mode-line-overtime :foreground warning)
   (spaceline-flycheck-warning :foreground warning)
   (xah-elisp-at-symbol :foreground warning)) ())
