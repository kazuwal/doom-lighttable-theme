...
(def-doom-theme doom-lighttable
  ...
  (((line-number &override) :foreground base4)
   ...
   (doom-modeline-buffer-major-mode :foreground "#CCCCCC")
   (doom-modeline-eldoc-bar :background green)
   (doom-modeline-bar-inactive :background bg) ; transparent
   ...
   (mode-line-emphasis  :foreground fg :background bg)
   (mode-line-highlight :foreground fg :background bg)
   (mode-line-buffer-id :foreground fg)
   (header-line :foreground fg)
